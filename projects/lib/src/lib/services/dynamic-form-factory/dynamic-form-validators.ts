...
export function patternListValidator(patterns: DynamicFormValidatorPattern[]): ValidatorFn {
  return (control: AbstractControl): ValidationErrors | null => {
