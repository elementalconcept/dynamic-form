...
export class DynamicFormFactoryService {
  ...
  createForm = <M>(config: DynamicFormConfig<M>,
                   value: DynamicFormValue,
                   componentMap: DynamicFormComponentMap<M>): DynamicForm<M> => {
  ...
  mapFormComponent = <M>(componentMap: DynamicFormComponentMap<M>, formGroup: UntypedFormGroup) =>
  ...
  insertFormControl = (value: DynamicFormValue, formGroup: UntypedFormGroup) =>
    <M>(element: DynamicFormElement<M>) => {
  ...
  createFormControl = (value: any, validators: ValidatorFn[]): UntypedFormControl => new UntypedFormControl(value, validators);
}
